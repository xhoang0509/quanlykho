...
public class fTraHang_Kho extends javax.swing.JFrame {
    ...
    public void listDanhSachKho() {
        ...
        // ChiTietLoSanPham ctlsp =
        // DAO.daoChiTietLoSanPham.getInstance().getChiTietLoSanPham(item.id_lo_sp);
        ...
        // PhieuNhap pn =
        // DAO.daoPhieuNhap.getInstance().getPhieuNhap(lsp.id_phieu_nhap);
        // ChiTietPhieuNhap ctpn =
        // DAO.daoChiTietPhieuNhap.getInstance().getChiTietPhieuNhap(pn.id_phieu_nhap);
        // NguonCungCap ncc =
        // DAO.daoNguonCungCap.getInstance().getNguonCungCap(ctpn.id_nguon_cc);
        // model.addRow(new Object[]{item.id_lo_sp, ncc.ten_nha_cc, sp.ten_sp,
        // item.sl_san_pham});
        // });
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(32, 32, 32)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jTextFieldTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButtonTimKiem))
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jButtonThoat, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButtonLuu, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTableLoMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTableLoMouseClicked
        ...
        // fCreate_PhieuXuat.getInstance().setText(tensp,
        // hsd,sl,nsx,loaisp,hinh_anh,id_lo);
    ...
    private void jButtonTimKiemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonTimKiemActionPerformed
        ...
        // ArrayList<infoList_fTraHang_Kho> arr =
        // DAO.daoLoSanPham.getInstance().getListInfoList_fTraHang_Kho();
        // arr.stream().forEach((item) -> {
        // model.addRow(new Object[]{item.id_lo_sp, item.ten_nha_cc, item.ten_sp,
        // item.sl_san_pham});
        // });
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fTraHang_Kho.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
